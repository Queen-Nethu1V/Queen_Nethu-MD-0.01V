...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || "JANA QUOTES ᥫᩣ",
    ...
    MENU_IMAGE_URL: process.env.MENU_IMAGE_URL || "https://files.catbox.moe/334aac.jpg",
    // add custom menu and mention reply image url

    ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/334aac.jpg",
    // add img for alive msg

    LIVE_MSG: process.env.LIVE_MSG || 
`> ʙᴏᴛ ɪs sᴘᴀʀᴋɪɴɢ ᴀᴄᴛɪᴠᴇ ᴀɴᴅ ᴀʟɪᴠᴇ

ᴋᴇᴇᴘ ᴜsɪɴɢ ✦ᴊᴀɴᴀ ᴍᴅ✦ ғʀᴏᴍ ᴊᴀɴᴀ ᴛᴇᴄʜ ɪɴᴄ⚡

*© ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ ᴊᴀɴᴀ- ᴍᴅ*

> ɢɪᴛʜᴜʙ : https://github.com/MASTER-JANA/JANA-MD`,
    // add alive msg here 

    STICKER_NAME: process.env.STICKER_NAME || "ᴋɪɴɢ ᴊᴀɴᴀ",
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "94720958258",
    // add your bot owner number

    OWNER_NAME: process.env.OWNER_NAME || "ᴍʀ ᴊᴀɴᴀ",
    // add bot owner name

    DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴍʀ ᴋɪɴɢ ᴊᴀɴᴀ*",
    ...
    DEV: process.env.DEV || "94720958258",
